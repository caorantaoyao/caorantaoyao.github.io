...
<link href="https://fonts.googleapis.com/css2?family=Noto+Serif+SC:wght@400;600;700&family=JetBrains+Mono:wght@300;400;500&display=swap" rel="stylesheet">
<style>
  :root {{
    --bg:#0b0b0d; --surface:#121215; --surface-raised:#1a1a1e; --border:#252528;
    --text:#e4e0d8; --text-muted:#7a7670; --text-dim:#4a4642;
    --accent:#c9a87c; --accent-dim:#8a6d4b; --green:#7a9a8a; --green-dim:#4a6a5a; --red:#c97c7c;
  ...
  *,*::before,*::after {{ margin:0; padding:0; box-sizing:border-box; }}
  ...
  nav {{ position:sticky; top:0; z-index:100; padding:1.2rem 0;
    backdrop-filter:blur(20px); background:rgba(11,11,13,0.75); border-bottom:1px solid var(--border); }}
  ...
  article {{ padding:clamp(3rem,8vh,5rem) 0 4rem; }}
...
<nav>
  <div class="container">
    <a href="/" class="nav-logo">CAORAN</a>
    <a href="/#essays" class="nav-back">← 返回文章列表</a>
  </div>
</nav>
